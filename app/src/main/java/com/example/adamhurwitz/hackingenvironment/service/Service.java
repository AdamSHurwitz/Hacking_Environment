...
import com.example.adamhurwitz.hackingenvironment.AsyncParcelableArrayAdapter;
import com.example.adamhurwitz.hackingenvironment.AsyncParcelableFetchDoodleDataTask;
import com.example.adamhurwitz.hackingenvironment.DoodleData;
...
public class Service extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        gridViewAdapter = new AsyncParcelableArrayAdapter(this,
                R.layout.grid_recentitem_layout, doodleDataList);

        String[] params = intent.getStringArrayExtra("service_extra");
        Log.v(LOG_TAG, "Service_receives_params: " + params[0] + " and " + params[1]);
    ...
    private ArrayList<DoodleData> parseJsonResponse(String jsonResponse)
        ...
        try {
            Log.v(LOG_TAG, "jsonResponse_passed_into_method: " + jsonResponse);
            ...
            Log.v(LOG_TAG, "return_DoodleDataList_size: " + doodleDataList.size());
