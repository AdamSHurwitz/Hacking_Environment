...
public class GridViewAsyncAdapter extends ArrayAdapter<DoodleData> {
    ...
    public GridViewAsyncAdapter(Context context, int resource, ArrayList<DoodleData> doodleDataList) {
